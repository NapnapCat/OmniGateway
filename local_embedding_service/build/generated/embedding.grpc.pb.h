...
class EmbeddingService final {
 public:
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GetEmbedding<ExperimentalWithCallbackMethod_Info<Service > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_GetEmbedding<ExperimentalWithCallbackMethod_Info<Service > > ExperimentalCallbackService;
  template <class BaseClass>
